...
_command* _create_keyboard_key_cmd_b(char key, uint32_t *interval_ms, bool down);
_command* _create_keyboard_key_cmd_uintt(char key, uint32_t *interval_ms, uint32_t hold_ms);
